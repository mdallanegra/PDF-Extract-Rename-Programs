...
def main():
    pdf_path = 'Copia_de_Transferencia_entre_cuentas_propias.pdf'  # Path to your PDF file
    ...
    if extracted_text:
        ...
        date_text = find_text_after_keyword(extracted_text, date_keyword)
        ...
        if date_text and ref_text:
            ...
            if not date_text:
                print(f"Keyword '{date_keyword}' not found in the text.")
            if not ref_text:
                print(f"Keyword '{ref_keyword}' not found in the text.")
    else:
